...
In this hands-on lab learners will enable various factors for multi-factor authentication in their labs- tenant, enforce MFA for users, and create rules to trigger MFA.
...
1. Clone this repository to your local machine.
  ```bash
  git clone https://github.com/auth0-training/labs-node-working-with-multi-factor-authentication.git
  ```
